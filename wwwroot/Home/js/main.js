...
const resultsPerPage = 50; // Number of results to display per page
...
<div class="card recipe-cards__card" style="width: 18rem;">
    ...
    <span onclick="toggleHeartIcon(this, '${result.recipe.label}', '${encodeURIComponent(JSON.stringify(result.recipe.url))}', '${result.recipe.image}')"
                class="recipe-cards__heart ${heartIconClass}">
                <i class="far fa-heart heart"></i>
            </span>
    <div class="card-body">
        <h5 class="card-title recipe-cards__title">${result.recipe.label}</h5>
        ...
        <div class="recipe-cards__badges">${healthLabelsPillsHTML}</div>
        <div class="d-flex justify-content-between align-items-center">
            <a href="${result.recipe.url}" class="btn recipe-cards__link" target="_blank">View Recipe</a>
