...
namespace MealProject.Controllers
{
    public class UserloginsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Userloginid,Email,Password,Userid,Roleid")] Userlogin userlogin)
        {
            ...
            ViewData["Userid"] = new SelectList(_context.Customers, "Userid", "Userid", userlogin.Userid);
            return View(userlogin);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Userloginid,Email,Password,Userid,Roleid")] Userlogin userlogin)
        {
